...
from models import PoseExpNet, DispResNet
...
parser.add_argument("--dataset-list", default='E:/PCProjects/UnsupDepth/kitti_eval/test_files_eigen.txt', type=str, help="Dataset list file")
...
def main():
    ...
    for j, sample in enumerate(tqdm(framework)):
        ...
        if (not args.no_resize) and (h != args.img_height or w != args.img_width):
            sample['focal_length'] = sample['focal_length'] *  args.img_width / w
        ...
        pred_depth = sample['baseline'] * sample['focal_length'] / (pred_disp * args.img_width + 0.01)
        # pred_depth = 0.54 * sample['focal_length'] / (pred_disp * args.img_width)
